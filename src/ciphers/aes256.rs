...
use crate::functions::*;
use crate::{CryptoError, CryptoTrait};
...
use aes::cipher::block_padding::{Block, Padding, Pkcs7};
use aes::Aes256;
...
#[derive(Debug, Clone)]
pub struct Crypto256 {
    key: BlockCipherKey<Aes256>,
    iv: Block<Aes256>,
}

impl CryptoTrait for Crypto256 {
    fn new<S: AsRef<str>, V: AsRef<str>>(key: S, iv: Option<V>) -> Crypto256 {
        let iv = match iv {
            Some(s) => {
